...
ans = eng.FG_main_engy_0107(subj, run, dist, n_motif, config_file)
...
if 1:
    ...
    if 1:
        ...
        crossValRes.to_csv( outfolder+'RF_185_motif_dist'+str(dist)+'_multi-thre_'+protocol+'_'+subj+'_run'+str(run)+'(109)_'+str(current_time)+'.csv', index = None)
